...
~
{\tt TDFstat}
{Data-analysis pipeline, implementing the network-of-detectors time-domain $\mathcal{F}$-statistic method search for almost monochromatic gravitational wave signals ({\tt github.com/Polgraw/}} 
{{\tt TDFstat})} 
~
{\tt SageManifolds}
